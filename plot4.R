...
png(filename = "plot4.png", width = plotWidth, height = plotHeight)

# Set up window for 2x2 plots
par(mfrow = c(2, 2), mar = c(5, 5, 4, 1), oma = c(0, 0, 0, 0))
